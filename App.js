...
//conditional statement to set the state variables
  ...
  const updateSqrt = op => {
    let enteredNumber = numberDisplay * 1;
    let newTotal = Math.sqrt(enteredNumber);
      ...
      <SafeAreaView style={styles.savContainer}>
        <View style={styles.calculatorContainer}>
          ...
          <View style={styles.buttonRow}>
            <FunctionButton ThisFunction="C" ButtonWidth="25%"  ButtonAction={changeDisplay} />
            <FunctionButton ThisFunction="delete" ButtonWidth="25%" ButtonAction={changeDisplay}  />
            <OperationButton Operation="sqrt" UpdateCalculations={updateSqrt}/>
